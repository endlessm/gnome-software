						  ...
						  GsApp *app)
{
	...
	static const char *arm_whitelist[] = {
		...
		"com.github.bilelmoussaoui.Authenticator.desktop",
		...
		"com.github.gyunaev.spivak.desktop",
