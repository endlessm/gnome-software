 ...
 * @GS_PLUGIN_REFINE_FLAGS_DETAILS_VIEW:		The refine is needed because the user is going into the app's details view
 *
 * The refine flags.
 **/
...
#define GS_PLUGIN_REFINE_FLAGS_DETAILS_VIEW		(1u << 25)
